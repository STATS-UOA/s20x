...
vignette: >
  %\VignetteIndexEntry{Case Study 17.2: Additional Time Series Case Study B: Google Influenza Searches Data}
...
| `week` | the calendar week in which the query was made (weeks 1–53) |
