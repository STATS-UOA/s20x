...
```{r RC-CS9_4-001, out.width = "75%", fig.align = 'center', eval=FALSE}
fev.df = read.csv("fev.csv")
head(fev.df)
```

```{r RC-CS9_4-0011, out.width = "75%", fig.align = 'center', echo=FALSE}
head(fev.df)
```

```{r RC-CS9_4-0012, out.width = "75%", fig.align = 'center'}
# Any missing values?
sum(is.na(fev.df))
...
```{r RC-CS9_4-019, out.width = "75%", fig.align = 'center', eval=requireNamespace("ggplot2", quietly = TRUE)}
