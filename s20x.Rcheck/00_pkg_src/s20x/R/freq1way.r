...
#' 
#' 
#' @param counts A 1-way frequency table as produced by table()
...
#' @param estimated default is 0. Subtracted from the df for the Chi-square
#' test.
...
#' 
#' @export freq1way
freq1way <- function(counts, hypothprob, conf.level = 0.95, addCIs = TRUE, digits = 4, arrowwid = 0.1, estimated = 0) ## note these have been Bonferroni adjusted for Multiple comparisons
{
